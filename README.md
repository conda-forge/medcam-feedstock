...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/medcam-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12344&branchName=master">
...
Once the `conda-forge` channel has been enabled, `medcam` can be installed with:

```
conda install medcam
```

It is possible to list all of the versions of `medcam` available on your platform with:
